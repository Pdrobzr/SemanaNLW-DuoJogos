import {GameController, MagnifyingGlassPlus, Check, DiscordLogo} from 'phosphor-react'
...
export function CreateAdModal(){
    ...
    useEffect(()=>{
        axios('http://localhost:8081/games')
       .then(response => {
      ...
      <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            defaultValue=""
            >
                <option disabled value="">Selecione o game desejado</option>
                {games.map(game =>{
          ...
          <div className='grid grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col gap-2'>
              <label htmlFor="discord">Qual é o id de seu discord?</label>
